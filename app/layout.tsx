...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={clsx("bg-black text-lg text-white", inter.className)}
    >
      <body suppressHydrationWarning className="antialiased max-w-2xl mb-40 flex flex-col md:flex-row mx-4 mt-8 lg:mx-auto">
